<%@ Page Title="" Language="C#" MasterPageFile="~/Adm_Course_Settings.master" AutoEventWireup="true" CodeFile="Adm_Course_Semester.aspx.cs" Inherits="Adm_Course_Semester" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div runat="server" id="search_section">
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <button id="btn_new" runat="server" onserverclick="btn_new_ServerClick" class="a_tag-btn"><span>Create Semester</span></button>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="add_section" runat="server">
        ...
        <h4><b>Create New Semester</b></h4>
        <div class="button-bg">
            <div class="top-hed-btn-left"></div>
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <a class="a_tag-btn" href="Adm_Course_Semester.aspx?mode=search"><span>Manage Semester</span></a></li>
                </ul>
            </div>
        </div>
                ...
                <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tbx_name" runat="server" CssClass="form-control" Width="250" AutoCompleteType="Disabled" MaxLength="120"></asp:TextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_save" ID="reqdocumentname" ControlToValidate="tbx_name" ErrorMessage="Semester Name cannot be blank." />
                            </td>
                        </tr>
                        <tr style="height: 5px;">
                            <td colspan="3"></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tbx_code" runat="server" Width="200px" AutoCompleteType="Disabled" MaxLength="120"></asp:TextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_save" ID="RequiredFieldValidator1" ControlToValidate="tbx_code" ErrorMessage="Code cannot be blank." /></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td colspan="3"></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddl_status" Width="150px" runat="server">
        ...
        <div class="form">
            <div class="button-bg">
                ...
                <div class="top-hed-btn-right">
                    <ul>
                        <li>
                            <a class="a_tag-btn" href="Adm_Course_Semester.aspx?mode=add"><span>Add Semester</span></a>            </li>
                        <li>
                            <a class="a_tag-btn" href="Adm_Course_Semester.aspx?mode=search"><span>Manage Semester</span></a>            </li>
                    </ul>
                </div>
                    ...
                    <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_editsave" ID="RequiredFieldValidator2" ControlToValidate="tbx_edit_name" ErrorMessage="Semester Name cannot be blank." />
                                </td>
                            </tr>
                            <tr style="height: 5px;">
                                <td colspan="3"></td>
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    ...
                    <li>
                        <button id="btn_manage" runat="server" onserverclick="btn_manage_ServerClick" class="a_tag-btn"><span>Manage Semester</span></button>
                    </li>
                </ul>
            </div>
