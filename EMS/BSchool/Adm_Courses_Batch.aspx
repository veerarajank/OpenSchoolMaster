<%@ Page Title="" Language="C#" MasterPageFile="~/Adm_Course_Settings.master" AutoEventWireup="true" CodeFile="Adm_Courses_Batch.aspx.cs" Inherits="Adm_Courses_Batch" %>
                            ...
                            <table style="width: 100%" border="0" cellspacing="0" cellpadding="0" class="s_search">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 2%"></td>
                                        <td style="width: 23%">
                                            <asp:Button ID="btn_new" runat="server" OnClick="btn_new_Click" CssClass="formbut-n" Text="Add Batch" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <div class="cont_right formWrapper">
            ...
            <div class="button-bg">
                ...
                <div class="top-hed-btn-right">
                    <ul>
                        <li>
                            <a class="a_tag-btn" href="Adm_Courses_Batch.aspx?mode=search"><span>Manage Batch</span></a></li>
                    </ul>
                </div>
            </div>
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 200px">
                                        <label for="Courses_batch_name" class="required">Batch <span class="required">*</span></label></td>
                                    <td>
                                        <asp:TextBox ID="tbx_name" AutoCompleteType="Disabled" runat="server" MaxLength="100" Width="250"></asp:TextBox>
                                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_save" ID="reqdocumentname" ControlToValidate="tbx_name" ErrorMessage="Batch Name cannot be blank." />
                                    </td>
                                </tr>
                                 <tr style="height:5px;">
                                    <td colspan="2" ></td>
                                ...
                                <tr>
                                    <td style="width: 200px">
                                        <label for="Courses_batchCode" class="required">Code<span class="required">*</span></label></td>
                                    <td>
        ...
        <div class="form">
            <div class="button-bg">
                ...
                <div class="top-hed-btn-right">
                    <ul>
                        <li>
                            <a class="a_tag-btn" href="Adm_Courses_Batch.aspx?mode=add"><span>Add Batch</span></a>            </li>
                        <li>
                            <a class="a_tag-btn" href="Adm_Courses_Batch.aspx?mode=search"><span>Manage Batch</span></a>            </li>
                    </ul>
                </div>
