<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Settings.master" AutoEventWireup="true" CodeFile="Adm_Student_Log.aspx.cs" Inherits="Adm_Student_Log" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div runat="server" id="search_section">
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <button id="btn_new" runat="server" onserverclick="btn_new_ServerClick" class="a_tag-btn"><span>Create Student Log</span></button>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="grid_table_con">
                <asp:ListView ID="lv_listview" runat="server" GroupPlaceholderID="groupPlaceHolder1"
                    ...
                    <ItemTemplate>
                        ...
                        <td>
                            <%# Convert.ToString(Eval("Is_allow")).ToLower()=="1" ? "<span class='bg-green'>&nbsp;Yes&nbsp;</span>" : "<span class='bg-red'>&nbsp;No&nbsp;</span>"  %>
                        </td>                        
                        <td>
    ...
    <div id="add_section" runat="server">
        ...
        <h4><b>Create New Student Log</b></h4>
        <div class="button-bg">
            <div class="top-hed-btn-left"></div>
            <div class="top-hed-btn-right">
                <ul>
            ...
            <div class="formConInner">
                ...
                <div class="row">
                    <div class="txtfld-col">
                        ...
                        <label for="Log_allow" class="required">&nbsp;Allow Teachers to Manage</label>
        ...
        <div class="form">
            ...
            <div class="formCon">
                <div class="formConInner">
                    ...
                    <div class="row">
                        <div class="txtfld-col">
                            <asp:CheckBox ID="chk_editallow" runat="server" Checked="false" />
                            <label for="Allow_Mandatory" class="required">&nbsp;Allow Teachers to Manage</label>
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    ...
                    <li>
                        <button id="btn_manage" runat="server" onserverclick="btn_manage_ServerClick" class="a_tag-btn"><span>Manage Student Log</span></button>
                    </li>
                </ul>
            </div>
        ...
        <div class="table_listbx">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        <td width="20%">
                            <b>Allow Teachers to Manage</b>
                        </td>
                        <td width="3%"><strong>:</strong></td>
                        <td width="77%">
                            <label id="lbl_allow" runat="server"></label>
