...
public partial class Adm_SetAcademicSettings : System.Web.UI.Page
{
    ...
    protected void btn_apply_Click(object sender, EventArgs e)
    {
        ...
        string str_qry = "Update tbl_setcurrentacademicyear_settings set academic_id=@academic_id where id=1";
        ies.Fn_ExecutiveSql(str_qry, 0, 1);
        Response.Redirect("Adm_SetAcademicSettings.aspx");
    }
}