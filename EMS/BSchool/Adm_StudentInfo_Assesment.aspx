<%@ Page Title="" Language="C#" MasterPageFile="~/GS247.master" AutoEventWireup="true" CodeFile="Adm_StudentInfo_Assesment.aspx.cs" Inherits="Adm_StudentInfo_Assesment" %>
                                ...
                                <div class="emp_tabwrapper">
                                    ...
                                    <div class="pagetab-bg-tag-a">
                                        <ul>
                                            ...
                                            <li class="active"><a href="#" id="lnk_student_assessment" runat="server" onserverclick="lnk_student_assessment_ServerClick">Assessments</a></li>
