<%@ Page Title="" Language="C#" MasterPageFile="~/Adm_Teacher_Settings.master" AutoEventWireup="true" CodeFile="Adm_Teacher_Department.aspx.cs" Inherits="Adm_Teacher_Department" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div runat="server" id="search_section">
        <h4><b>Manage Teacher Departments</b></h4>
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <button id="btn_new" runat="server" onserverclick="btn_new_ServerClick" class="a_tag-btn"><span>Create Teacher Department</span></button>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="add_section" runat="server">
        ...
        <h4><b>Create New Teacher Department</b></h4>
        <div class="button-bg">
            <div class="top-hed-btn-left"></div>
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <a class="a_tag-btn" href="Adm_Teacher_Department.aspx?mode=search"><span>Manage Teacher Departments</span></a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="formConInner">
                <div class="row">
                    <div class="txtfld-col">
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_save" ID="reqdocumentname" ControlToValidate="tbx_name" ErrorMessage="Department Name cannot be blank." />
                    </div>
    ...
    <div id="update_section" runat="server">
        ...
        <h4><b>Update Teacher Department</b></h4>
        <div class="form">
            <div class="button-bg">
                <div class="top-hed-btn-left"></div>
                <div class="top-hed-btn-right">
                    <ul>
                        <li>
                            <a class="a_tag-btn" href="Adm_Teacher_Department.aspx?mode=add"><span>Add Teacher Department</span></a>            </li>
                        <li>
                            <a class="a_tag-btn" href="Adm_Teacher_Department.aspx?mode=search"><span>Manage Teacher Departments</span></a>            </li>
                    </ul>
                </div>
            ...
            <div class="formCon">
                <div class="formConInner">
                    ...
                    <div class="txtfld-col">
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_editsave" ID="RequiredFieldValidator2" ControlToValidate="tbx_edit_name" ErrorMessage="Department Name cannot be blank." />
                    </div>
    ...
    <div id="view_section" runat="server">
        ...
        <h4><b>View Teacher Department</b></h4>
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    ...
                    <li>
                        <button id="btn_manage" runat="server" onserverclick="btn_manage_ServerClick" class="a_tag-btn"><span>Manage Teacher Department</span></button>
                    </li>
                </ul>
            </div>
