<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Settings.master" AutoEventWireup="true" CodeFile="Adm_Course_Common_Class_Timings.aspx.cs" Inherits="Adm_Course_Common_Class_Timings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div runat="server" id="search_section">
        ...
        <h4><b>Manage Common Class Timings</b></h4>
    ...
    <div id="add_section" runat="server">
            ...
            <div class="formConInner">
                ...
                <div class="txtfld-col-btn">
                    ...
                    <div class="txtfld-col">
                        ...
                        <asp:TextBox ID="tbx_start_time" runat="server" AutoCompleteType="Disabled" class="hasDatepicker"></asp:TextBox>

                    </div>
                    <div class="txtfld-col">
                        <label for="end_time" class="required">End Time<span class="required">*</span></label>
                        <asp:TextBox ID="tbx_end_time" runat="server" AutoCompleteType="Disabled" class="hasDatepicker"></asp:TextBox>
                    </div>
                    <div class="txtfld-col">
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <button id="btn_newtiming" runat="server" style="width: 150px" onserverclick="btn_newtiming_ServerClick" class="a_tag-btn"><span>Create Class timing</span></button>
                    </li>
                </ul>
            </div>
        </div>
