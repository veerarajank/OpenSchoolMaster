<%@ Page Title="" Language="C#" MasterPageFile="~/GS247.master" AutoEventWireup="true" CodeFile="Adm_StudentInfo_Attendance.aspx.cs" Inherits="Adm_StudentInfo_Attendance" %>
                                ...
                                <div class="emp_tabwrapper">
                                    ...
                                    <div class="pagetab-bg-tag-a">
                                        <ul>
                                            ...
                                            <li class="active"><a href="#" id="lnk_student_attendance" runat="server" onserverclick="lnk_student_attendance_ServerClick">Attendance</a></li>
