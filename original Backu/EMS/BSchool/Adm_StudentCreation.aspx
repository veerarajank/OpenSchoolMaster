<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Settings.master" AutoEventWireup="true" CodeFile="Adm_StudentCreation.aspx.cs" Inherits="Adm_StudentCreation" %>
    ...
    <div class="cont_right formWrapper">
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <asp:Button ID="btn_guradian" validationgroup="vd_save" runat="server" Text="Guardian Details" OnClick="btn_guradian_Click" CssClass="a_tag-btn" />
                    </li>
                </ul>
            </div>
