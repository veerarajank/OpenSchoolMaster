<%@ Page Title="" Language="C#" MasterPageFile="~/GS247.master" AutoEventWireup="true" CodeFile="Adm_Teacher_View_log.aspx.cs" Inherits="Adm_Teacher_View_log" %>
                                ...
                                <div class="emp_tabwrapper">
                                    ...
                                    <div class="pagetab-bg-tag-a">
                                        <ul>
                                            ...
                                            <li class="active"><a href="#" id="lnk_teacher_log" runat="server" onserverclick="lnk_teacher_log_ServerClick">Log</a></li>
