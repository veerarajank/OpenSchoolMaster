<%@ Page Title="" Language="C#" MasterPageFile="~/Adm_Teacher_Settings.master" AutoEventWireup="true" CodeFile="Adm_Teacher_Category.aspx.cs" Inherits="Adm_Teacher_Category" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div runat="server" id="search_section">
        <h4><b>Manage Teacher Category</b></h4>
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <button id="btn_new" runat="server" onserverclick="btn_new_ServerClick" class="a_tag-btn"><span>Create Teacher Category</span></button>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="add_section" runat="server">
        ...
        <h4><b>Create New Teacher Category</b></h4>
        <div class="button-bg">
            <div class="top-hed-btn-left"></div>
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <a class="a_tag-btn" href="Adm_Teacher_Category.aspx?mode=search"><span>Manage Teacher Category</span></a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="formConInner">
                <div class="row">
                    <div class="txtfld-col">
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_save" ID="reqdocumentname" ControlToValidate="tbx_name" ErrorMessage="Category Name cannot be blank." />
                    </div>

                </div>
                <div class="row">
                    <div class="txtfld-col">
                        <label for="Code" class="required">&nbsp;Prefix <span class="required">*</span></label>
                        <asp:TextBox ID="tbx_code" runat="server" AutoCompleteType="Disabled" MaxLength="120"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_save" ID="RequiredFieldValidator1" ControlToValidate="tbx_code" ErrorMessage="Prefix cannot be blank." />
                    </div>
                </div>
                <div class="row">
                    <div class="txtfld-col">
    ...
    <div id="update_section" runat="server">
        ...
        <h4><b>Update Teacher Category</b></h4>
        <div class="form">
            <div class="button-bg">
                <div class="top-hed-btn-left"></div>
                <div class="top-hed-btn-right">
                    <ul>
                        <li>
                            <a class="a_tag-btn" href="Adm_Teacher_Category.aspx?mode=add"><span>Add Teacher Category</span></a>            </li>
                        <li>
                            <a class="a_tag-btn" href="Adm_Teacher_Category.aspx?mode=search"><span>Manage Teacher Category</span></a>            </li>
                    </ul>
                </div>
            ...
            <div class="formCon">
                <div class="formConInner">
                    ...
                    <div class="txtfld-col">
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_editsave" ID="RequiredFieldValidator2" ControlToValidate="tbx_edit_name" ErrorMessage="Category Name cannot be blank." />
                    </div>
                ...
                <div class="row">
                    <div class="txtfld-col">
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_editsave" ID="RequiredFieldValidator3" ControlToValidate="tbx_edit_code" ErrorMessage="Prefix cannot be blank." />
                    </div>
                </div>
                <div class="row">
                    <div class="txtfld-col">
    ...
    <div id="view_section" runat="server">
        ...
        <h4><b>View Teacher Category</b></h4>
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    ...
                    <li>
                        <button id="btn_manage" runat="server" onserverclick="btn_manage_ServerClick" class="a_tag-btn"><span>Manage Teacher Category</span></button>
                    </li>
                </ul>
            </div>
