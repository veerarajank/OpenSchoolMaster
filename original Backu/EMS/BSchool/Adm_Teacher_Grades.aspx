<%@ Page Title="" Language="C#" MasterPageFile="~/Adm_Teacher_Settings.master" AutoEventWireup="true" CodeFile="Adm_Teacher_Grades.aspx.cs" Inherits="Adm_Teacher_Grades" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div runat="server" id="search_section">
        <h4><b>Manage Teacher Grades</b></h4>
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <button id="btn_new" runat="server" onserverclick="btn_new_ServerClick" class="a_tag-btn"><span>Create Teacher Grade</span></button>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="add_section" runat="server">
        ...
        <h4><b>Create New Teacher Grade</b></h4>
        <div class="button-bg">
            <div class="top-hed-btn-left"></div>
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <a class="a_tag-btn" href="Adm_Teacher_Grades.aspx?mode=search"><span>Manage Teacher Grades</span></a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="formCon">
            <div class="formConInner">
                <div class="row">
                 ...
                 <div class="row">
                    <div class="txtfld-col">
                        <label for="Code" class="required">&nbsp;Max Hours Day <span class="required">*</span></label>
                        <asp:TextBox ID="tbx_maxdays" runat="server" AutoCompleteType="Disabled" MaxLength="120"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_save" ID="RequiredFieldValidator4" ControlToValidate="tbx_maxdays" ErrorMessage="Max Hours Day cannot be blank." />
                    </div>
                     <div class="txtfld-col">
                        <label for="Code" class="required">&nbsp;Max Hours Week <span class="required">*</span></label>
                        <asp:TextBox ID="tbx_maxweek" runat="server" AutoCompleteType="Disabled" MaxLength="120"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_save" ID="RequiredFieldValidator5" ControlToValidate="tbx_maxweek" ErrorMessage="Max Hours Week cannot be blank." />
                    </div>
                </div>                
                <div class="row">
                    <div class="txtfld-col">
    ...
    <div id="update_section" runat="server">
        ...
        <h4><b>Update Teacher Grade</b></h4>
        <div class="form">
            <div class="button-bg">
                <div class="top-hed-btn-left"></div>
                <div class="top-hed-btn-right">
                    <ul>
                        <li>
                            <a class="a_tag-btn" href="Adm_Teacher_Grades.aspx?mode=add"><span>Add Teacher Grade</span></a>            </li>
                        <li>
                            <a class="a_tag-btn" href="Adm_Teacher_Grades.aspx?mode=search"><span>Manage Teacher Grades</span></a>            </li>
                    </ul>
                </div>
            ...
            <div class="formCon">
                <div class="formConInner">
                    ...
                    <div class="txtfld-col">
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_editsave" ID="RequiredFieldValidator2" ControlToValidate="tbx_edit_name" ErrorMessage="Grade Name cannot be blank." />
                    </div>
                        <div class="txtfld-col">
                        <label for="Code" class="required">&nbsp;Code <span class="required">*</span></label>
                ...
                <div class="row">
                    <div class="txtfld-col">
                        <label for="Code" class="required">&nbsp;Max Hours Day <span class="required">*</span></label>
                        <asp:TextBox ID="tbx_edit_maxdays" runat="server" AutoCompleteType="Disabled" MaxLength="120"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_editsave" ID="RequiredFieldValidator6" ControlToValidate="tbx_edit_maxdays" ErrorMessage="Max Hours Day cannot be blank." />
                    </div>
                     <div class="txtfld-col">
                        <label for="Code" class="required">&nbsp;Max Hours Week <span class="required">*</span></label>
                        <asp:TextBox ID="tbx_edit_maxweek" runat="server" AutoCompleteType="Disabled" MaxLength="120"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" CssClass="input-notification-error  error-simple png_bg" ValidationGroup="vd_editsave" ID="RequiredFieldValidator7" ControlToValidate="tbx_edit_maxweek" ErrorMessage="Max Hours Week cannot be blank." />
                    </div>
                </div> 
                <div class="row">
                    <div class="txtfld-col">
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    ...
                    <li>
                        <button id="btn_manage" runat="server" onserverclick="btn_manage_ServerClick" class="a_tag-btn"><span>Manage Teacher Grade</span></button>
                    </li>
                </ul>
            </div>
            ...
            <table style="width:100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:3%" ><strong>:</strong></td>
                        <td style="width:77%">
                            <label id="lbl_maxdays" runat="server"></label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:20%">
                        ...
                        <td style="width:3%" ><strong>:</strong></td>
                        <td style="width:77%">
                            <label id="lbl_maxweek" runat="server"></label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:20%">
