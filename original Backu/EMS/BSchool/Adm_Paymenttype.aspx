<%@ Page Title="" Language="C#" MasterPageFile="~/Adm_FeesSettings.master" AutoEventWireup="true" CodeFile="Adm_Paymenttype.aspx.cs" Inherits="Adm_Paymenttype" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div runat="server" id="search_section">
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <button id="btn_new" runat="server" onserverclick="btn_new_ServerClick" class="a_tag-btn"><span>Create Payment Type</span></button>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="add_section" runat="server">
        ...
        <h4><b>Create New Payment Type</b></h4>
       <br />
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    <li>
                        <button id="btn_createeventtype" runat="server" style="width:150px"  onserverclick="btn_createeventtype_ServerClick" class="a_tag-btn"><span>Create Payment Type</span></button>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="form">
            <div class="button-bg">
                ...
                <div class="top-hed-btn-right">
                    <ul>
                        <li>
                            <a class="a_tag-btn" href="Adm_Paymenttype.aspx?mode=add"><span>Add Payment Type</span></a>            </li>
                        <li>
                            <a class="a_tag-btn" href="Adm_Paymenttype.aspx?mode=search"><span>Manage Payment Type</span></a>            </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="button-bg">
            ...
            <div class="top-hed-btn-right">
                <ul>
                    ...
                    <li>
                        <button id="btn_manage" runat="server" onserverclick="btn_manage_ServerClick" class="a_tag-btn"><span>Manage Payment Type</span></button>
                    </li>
                </ul>
            </div>
