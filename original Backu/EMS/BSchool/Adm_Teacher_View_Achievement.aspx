<%@ Page Title="" Language="C#" MasterPageFile="~/GS247.master" AutoEventWireup="true" CodeFile="Adm_Teacher_View_Achievement.aspx.cs" Inherits="Adm_Teacher_View_Achievement" %>
                                ...
                                <div class="emp_tabwrapper">
                                    ...
                                    <div class="pagetab-bg-tag-a">
                                        <ul>
                                            ...
                                            <li class="active"><a href="#"  id="lnk_teacher_achievement" runat="server" onserverclick="lnk_teacher_achievement_ServerClick">Achievements</a></li>
                                        ...
                                        <div class="pdtab_Con">                                            
                                            <table style="width: 100%" border="0" cellspacing="0" cellpadding="0" style="border-top: none;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="3" style="text-align: center;">No document(s) uploaded</td>
                                                        <td></td>
                                                    </tr>
                                                </tbody>
                                            </table>
