...
public partial class Adm_StudentInfo_Achievements : System.Web.UI.Page
{
    ...
    protected void BindListView()
    {
        ...
        DataTable dt_data = ies.Fn_ExecutiveSql_Datatable("select * from tbl_student_achievement where student_id=@student_id", 0, 1);
        if (dt_data != null)
        {
    ...
    protected void SaveData()
    {
        ...
        string File_Folder = "Achievement";
        if (System.IO.Directory.Exists(HttpContext.Current.Server.MapPath("~/student/Documents/" + year + "/" + admission_no + "/" + File_Folder)) == false)
        {
            System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath("~/student/Documents/" + year + "/" + admission_no + "/" + File_Folder));
        }

        string Achievement_Title = Convert.ToString(tbx_achievement_title.Text);
        string Achievement_Desc = Convert.ToString(tbx_description.Text);
        string doc_name = Convert.ToString(tbx_documentname.Text);
        string doc_filename = "";
        string doc_map_path = "";
        ...
        {
            doc_map_path = "~/student/Documents/" + year + "/" + admission_no + "/Achievement/" + System.IO.Path.GetFileName(file_upload.FileName);
            doc_filename = System.IO.Path.GetFileName(file_upload.FileName);
            string file_folder = Convert.ToString(HttpContext.Current.Server.MapPath("~/student/Documents/" + year + "/" + admission_no + "/Achievement"));
        ...
        ies.ies_parameters.Add("@Achievement_Title", Convert.ToString(Achievement_Title).Trim());
        ies.ies_parameters.Add("@Achievement_Desc", Convert.ToString(Achievement_Desc).Trim());
        ...
        ies.ies_parameters.Add("@doc_name", Convert.ToString(doc_name).Trim());
        ...
        DataTable dt_result = ies.Fn_ExecutiveSql_Datatable("UDP_Student_Achievement", 1, 1);
    ...
    protected void ln_deleted_Command(object sender, CommandEventArgs e)
    {
        ...
        if (e.CommandName == "delete")
        {
            ...
            ies.Fn_ExecutiveSql("UDP_Student_Achievement", 1, 1);
        }
        BindListView();
    }
