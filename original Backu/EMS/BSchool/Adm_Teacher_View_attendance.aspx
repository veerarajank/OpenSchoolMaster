<%@ Page Title="" Language="C#" MasterPageFile="~/GS247.master" AutoEventWireup="true" CodeFile="Adm_Teacher_View_attendance.aspx.cs" Inherits="Adm_Teacher_View_attendance" %>
                                ...
                                <div class="emp_tabwrapper">
                                    ...
                                    <div class="pagetab-bg-tag-a">
                                        <ul>
                                            ...
                                            <li  class="active"><a href="#" id="lnk_teacher_attendance" runat="server" onserverclick="lnk_teacher_attendance_ServerClick">Attendance</a></li>
