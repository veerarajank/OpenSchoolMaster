<%@ Page Title="" Language="C#" MasterPageFile="~/Adm_Course_Settings.master" AutoEventWireup="true" CodeFile="Adm_Course_Batches_Semester_List.aspx.cs" Inherits="Adm_Course_Batches_Semester_List" %>
                        ...
                        <table style="width: 100%" border="0" cellspacing="0" cellpadding="0" class="s_search">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 2%">:</td>
                                    <td style="width: 25%">
                                        <asp:Label ID="lbl_displaycourse" runat="server" Font-Bold="true"></asp:Label>
                                    </td>
                                    <td style="width: 2%"></td>
